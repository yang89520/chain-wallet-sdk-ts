...
export function createSuiAddress(seedHex: string, receiveOrChange: string, addresIndex: string, mainnet: string): any {
...
export function verifySuiAddress (params: { address: string }) {
...
export function importSuiAddress (params: { privateKey: string}) {
