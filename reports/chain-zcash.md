...
### 2.3 Zcash链模型
- 经过区块浏览器考证，典型**UTXO（Unspent Transaction Output）模型**
...
- 获取地址余额：`getaddressbalance`

  - 参数：`["t1QzsGFr2iNTxNGAmhw2Nv8P85BG9XU31JJ"]`

  - 结果：因隐私原因，获取失败，需在节点中开启该功能
